...
export function NavItem ({title, icon: Icon}: NavItemProps){
    return(
        <a href="" className="group flex items-center gap-3 rounded px-3 py-2 border border-transparent bg-zinc-700 hover:bg-violet-500 hover:border hover:border-white">
